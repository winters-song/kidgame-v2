...
const autohelperbarrierspat129 = function (trans, move, color, action){
  ...
  if (!action) {
    return this.safe_move(a, color) && (this.somewhere(color, 0, 1, [e]) || this.play_attack_defend_n(color, 1, 2, a, e, e))&& !play_attack_defend2_n(color, 0, 3, [a, b, c, b, D]);
  }
...
const autohelperbarrierspat151 = function (trans, move, color, action){
  ...
  if (!false_eye_territory[a]) {
    this.influence_mark_non_territory(a, color);
  }
  if (!false_eye_territory[b]) {
...
const autohelperbarrierspat152 = function (trans, move, color, action){
  ...
  if ((this.is_halfeye(half_eye,a) || this.is_false_eye(half_eye, a)) 
  && this.safe_move(b, color) && !false_eye_territory[a]) {
...
const autohelperbarrierspat153 = function (trans, move, color, action){
  ...
  if (this.is_false_eye(half_eye, a) && !false_eye_territory[a]) {
    this.influence_mark_non_territory(a, color);
  }
  return 0;
...
const autohelperbarrierspat156 = function (trans, move, color, action){
  ...
  if (!false_eye_territory[a]) this.influence_mark_non_territory(a, color);
  if (!false_eye_territory[b]) this.influence_mark_non_territory(b, this.board.OTHER_COLOR(color));;
