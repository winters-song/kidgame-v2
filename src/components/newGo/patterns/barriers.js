...
const autohelperbarrierspat5 = function (trans, move, color, action){
  const a = AFFINE_TRANSFORM(608, trans, move);

  return !this.play_attack_defend_n(color, 1, 1, [a, a]);
}
const autohelperbarrierspat7 = function (trans, move, color, action){
  const a = AFFINE_TRANSFORM(648, trans, move);
  const b = AFFINE_TRANSFORM(611, trans, move);
  const c = AFFINE_TRANSFORM(610, trans, move);
  const d = AFFINE_TRANSFORM(647, trans, move);

  return this.play_attack_defend2_n(color, 1, 3, [a, b, c, a, c]) || !this.play_attack_defend2_n(color, 1, 2, [a, b, b, d]);
}
const autohelperbarrierspat8 = function (trans, move, color, action){
  const a = AFFINE_TRANSFORM(684, trans, move);
...
const autohelperbarrierspat13 = function (trans, move, color, action){
  ...
  const c = AFFINE_TRANSFORM(721, trans, move);

  return !this.safe_move(a, color) || this.play_attack_defend2_n(color, 0, 1, [a, b, c]);
}

const autohelperbarrierspat16 = function (trans, move, color, action){
  const a = AFFINE_TRANSFORM(722, trans, move);
  const b = AFFINE_TRANSFORM(721, trans, move);
  const c = AFFINE_TRANSFORM(759, trans, move);

  return !this.play_attack_defend2_n(color, 1, 2, [a, b, b, c]);
}
const autohelperbarrierspat18 = function (trans, move, color, action){
  ...
  const e = AFFINE_TRANSFORM(758, trans, move);
  const f = AFFINE_TRANSFORM(685, trans, move);

  return (this.play_attack_defend2_n(color, 1, 3, [a, b, f, a, f]) 
    || !this.play_attack_defend2_n(color, 1, 2, [a, b, c, d]))
  && (this.play_attack_defend2_n(color, 1, 3, [b, a, e, b, e])
   || !this.play_attack_defend2_n(color, 1, 2, [b, a, c, d]));
...
const autohelperbarrierspat19 = function (trans, move, color, action){
  ...
  const b = AFFINE_TRANSFORM(722, trans, move);
  const c = AFFINE_TRANSFORM(684, trans, move);
  const d = AFFINE_TRANSFORM(758, trans, move);
  const f = AFFINE_TRANSFORM(685, trans, move);

  return (this.play_attack_defend2_n(color, 1, 3, [a, b, f, a, f]) 
  || !this.play_attack_defend2_n(color, 1, 2, [a, b, c, d]))
  && !this.play_attack_defend_n(color, 1, 2, [b, a, c]);
...
const autohelperbarrierspat20 = function (trans, move, color, action){
  ...
  return !this.play_attack_defend2_n(color, 1, 2, [a, b, c, d])&& 
  (this.play_attack_defend2_n(color, 1, 3, [b, a, e, b, e]) || 
  !this.play_attack_defend2_n(color, 1, 2, [b, a, c, d]));
...
const autohelperbarrierspat22 = function (trans, move, color, action){
  ...
  return !this.play_break_through_n(color, 3, [a, b, c, a, c, d]);
...
const autohelperbarrierspat23 = function (trans, move, color, action){
  ...
  const c = AFFINE_TRANSFORM(722, trans, move);
  const d = AFFINE_TRANSFORM(759, trans, move);
  const e = AFFINE_TRANSFORM(795, trans, move);

  return !this.play_attack_defend2_n(color, 1, 3, [a, b, c, a, c]) 
  || !this.play_attack_defend2_n(color, 1, 3, [b, a, d, d, e]);

}
const autohelperbarrierspat25 = function (trans, move, color, action){
  const a = AFFINE_TRANSFORM(757, trans, move);
  const b = AFFINE_TRANSFORM(758, trans, move);
  const c = AFFINE_TRANSFORM(721, trans, move);
  const d = AFFINE_TRANSFORM(720, trans, move);

  return !this.play_attack_defend2_n(color, 1, 4, [a, b, c, d, b, d]) 
  && !this.play_attack_defend2_n(color, 1, 4, [d, c, b, a, c, a]);

}
const autohelperbarrierspat27 = function (trans, move, color, action){
  const a = AFFINE_TRANSFORM(758, trans, move);
  const b = AFFINE_TRANSFORM(759, trans, move);
  const c = AFFINE_TRANSFORM(722, trans, move);
  const d = AFFINE_TRANSFORM(721, trans, move);
...
const autohelperbarrierspat28 = function (trans, move, color, action){
  ...
  const b = AFFINE_TRANSFORM(758, trans, move);
  const c = AFFINE_TRANSFORM(759, trans, move);
  const d = AFFINE_TRANSFORM(722, trans, move);

  return this.play_attack_defend2_n(color, 1, 4, [a, b, c, d, b, d])
   || this.play_attack_defend2_n(color, 0, 4, [a, b, c, d, a, c]);
...
const autohelperbarrierspat34 = function (trans, move, color, action){
  ...
  return !this.play_attack_defend2_n(color, 1, 1, [a, a, b]);
...
const autohelperbarrierspat38 = function (trans, move, color, action){
  ...
  return this.play_attack_defend_n(color, 1, 1, [a, B]);
}
...
const autohelperbarrierspat43 = function (trans, move, color, action){
  ...
  return bd.countlib(A)>3 || (!bd.is_legal(b, color))|| (bd.countlib(A)>2 && (bd.accuratelib(b, color, bd.MAX_LIBERTIES, null) <= 2 || this.play_attack_defend2_n(color, 1, 3, [c, d, b, b, c])));
...
const autohelperbarrierspat48 = function (trans, move, color, action){
  ...
  const b = AFFINE_TRANSFORM(722, trans, move);
  const c = AFFINE_TRANSFORM(721, trans, move);
  const d = AFFINE_TRANSFORM(796, trans, move);
  const e = AFFINE_TRANSFORM(795, trans, move);

  return this.play_attack_defend2_n(color, 0, 4, [a, b, c, d, a, e]);
}
const autohelperbarrierspat49 = function (trans, move, color, action){
  ...
  return this.play_attack_defend2_n(color, 1, 2, [a, b, b, D]) || this.play_attack_defend2_n(color, 0, 2, [a, b, a, c]);
...
const autohelperbarrierspat51 = function (trans, move, color, action){
  ...
  const d = AFFINE_TRANSFORM(722, trans, move);
  const E = AFFINE_TRANSFORM(647, trans, move);

  return this.play_attack_defend2_n(color, 1, 4, [a, b, c, d, d, b]) && !this.play_attack_defend2_n(color, 0, 3, [a, c, b, c, E]);

}
const autohelperbarrierspat59 = function (trans, move, color, action){
  const a = AFFINE_TRANSFORM(574, trans, move);
...
const autohelperbarrierspat62 = function (trans, move, color, action){
  const b = AFFINE_TRANSFORM(684, trans, move);
  const c = AFFINE_TRANSFORM(795, trans, move);
  const A = AFFINE_TRANSFORM(721, trans, move);
  const bd = this.board

  return bd.countlib(A)<= 3 && bd.countlib(b)>= 3 && bd.countlib(c)>= 3;
}
...
const autohelperbarrierspat66 = function (trans, move, color, action){
  ...
  const c = AFFINE_TRANSFORM(757, trans, move);
  const A = AFFINE_TRANSFORM(720, trans, move);
  const bd = this.board

  return bd.countlib(A)<=2 && bd.countlib(b)>1 && bd.countlib(c)>1;
}
const autohelperbarrierspat67 = function (trans, move, color, action){
  const a = AFFINE_TRANSFORM(682, trans, move);
  const b = AFFINE_TRANSFORM(719, trans, move);

  return this.play_attack_defend_n(color, 1, 2, [a, b, b]);
}
const autohelperbarrierspat73 = function (trans, move, color, action){
  ...
  return !this.play_attack_defend_n(color, 1, 3, [a, b, c, c]);
}
const autohelperbarrierspat74 = function (trans, move, color, action){
  ...
  return this.play_attack_defend_n(color, 1, 2, [a, b, C]);
}
const autohelperbarrierspat77 = function (trans, move, color, action){

  const a = AFFINE_TRANSFORM(571, trans, move);
  const b = AFFINE_TRANSFORM(534, trans, move);
  const c = AFFINE_TRANSFORM(533, trans, move);
  const bd = this.board

  return bd.countlib(a)>2 || (bd.countlib(a) === 2 && this.connect_and_cut_helper(a, b, c));

}
const autohelperbarrierspat78 = function (trans, move, color, action){
  const a = AFFINE_TRANSFORM(608, trans, move);
  const b = AFFINE_TRANSFORM(571, trans, move);
  const c = AFFINE_TRANSFORM(570, trans, move);
  const bd = this.board

  if (!action) {
    return this.safe_move(c, color);
  }
  return bd.countlib(a)>2 || (bd.countlib(a) === 2 && this.connect_and_cut_helper(a, b, c))
}
...
const autohelperbarrierspat80 = function (trans, move, color, action){
  const a = AFFINE_TRANSFORM(497, trans, move);
  const b = AFFINE_TRANSFORM(571, trans, move);
  const c = AFFINE_TRANSFORM(534, trans, move);
  const d = AFFINE_TRANSFORM(533, trans, move);
  const bd = this.board

  if (!action){
    return this.safe_move(a, color);
  }
  return (bd.countlib(b)>2 || (bd.countlib(b) === 2 && this.connect_and_cut_helper(b, c, d)));;

}

const autohelperbarrierspat81 = function (trans, move, color, action){
  const a = AFFINE_TRANSFORM(459, trans, move);
  const b = AFFINE_TRANSFORM(534, trans, move);
  const c = AFFINE_TRANSFORM(533, trans, move);

  return !this.play_attack_defend_n(color, 0, 3, [a, b, c, b]);

}
const autohelperbarrierspat82 = function (trans, move, color, action){
  const a = AFFINE_TRANSFORM(462, trans, move);
  const b = AFFINE_TRANSFORM(535, trans, move);
  const c = AFFINE_TRANSFORM(536, trans, move);
  const d = AFFINE_TRANSFORM(572, trans, move);

  if (!action){
    return !this.play_attack_defend_n(color, 1, 3, [a, b, c, d]);
  }
  return !this.play_attack_defend_n(this.board.OTHER_COLOR(color), 1, 1, [b, d])
}
...
const autohelperbarrierspat84 = function (trans, move, color, action){
  ...
  return !this.play_attack_defend_n(this.board.OTHER_COLOR(color), 1, 1, [a, d]);
...
const autohelperbarrierspat86 = function (trans, move, color, action){
  ...
  const b = AFFINE_TRANSFORM(610, trans, move);
  const c = AFFINE_TRANSFORM(685, trans, move);
  const f = AFFINE_TRANSFORM(647, trans, move);
  const D = AFFINE_TRANSFORM(648, trans, move);
  const E = AFFINE_TRANSFORM(684, trans, move);

  if (!action) {
    return !this.play_attack_defend2_n(color, 0, 3, [a, b, c, D, E]);
  }
  return !this.play_attack_defend_n(this.board.OTHER_COLOR(color), 1, 1, [b, f])
}

const autohelperbarrierspat87 = function (trans, move, color, action){

  const a = AFFINE_TRANSFORM(647, trans, move);
  const b = AFFINE_TRANSFORM(648, trans, move);

  return !this.play_attack_defend_n(this.board.OTHER_COLOR(color), 1, 1, [b, a])
}
...
const autohelperbarrierspat88 = function (trans, move, color, action){
  ...
  if (!action){
    return this.play_attack_defend2_n(color, 1, 2, [a, b, C, b]);
  }
  return !this.play_attack_defend_n(this.board.OTHER_COLOR(color), 1, 1, [b, c])
...
const autohelperbarrierspat91 = function (trans, move, color, action){
  ...
  const a = AFFINE_TRANSFORM(721, trans, move);
  const b = AFFINE_TRANSFORM(684, trans, move);
  const C = AFFINE_TRANSFORM(720, trans, move);

  return this.play_attack_defend_n(color, 1, 2, [a, b, C]);
}
const autohelperbarrierspat92 = function (trans, move, color, action){
  const a = AFFINE_TRANSFORM(534, trans, move);
  const b = AFFINE_TRANSFORM(497, trans, move);
  const d = AFFINE_TRANSFORM(571, trans, move);
  const e = AFFINE_TRANSFORM(569, trans, move);
  const f = AFFINE_TRANSFORM(606, trans, move);
  const g = AFFINE_TRANSFORM(607, trans, move);
  const h = AFFINE_TRANSFORM(608, trans, move);
  const C = AFFINE_TRANSFORM(533, trans, move);
  ...
  return !this.play_attack_defend_n(this.board.OTHER_COLOR(color), 1, 1, [a, d]) 
  && this.somewhere(color, 0, 4, [g, e, f, h])
...
const autohelperbarrierspat93 = function (trans, move, color, action){
  ...
  return this.play_attack_defend_n(color, 1, 2, [a, b, b]) 
  && this.play_attack_defend_n(color, 1, 2, [c, d, d]);
...
const autohelperbarrierspat95 = function (trans, move, color, action){
  ...
  if (!action) {
    return this.somewhere(color, 0, 1, b) || this.play_attack_defend2_n(color, 1, 2, [a, b, b, C]);
  }
  return !this.play_attack_defend_n(this.board.OTHER_COLOR(color), 1, 1, [b, d])
...
const autohelperbarrierspat96 = function (trans, move, color, action){
  ...
  const a = AFFINE_TRANSFORM(573, trans, move);
  const b = AFFINE_TRANSFORM(499, trans, move);
...
const autohelperbarrierspat98 = function (trans, move, color, action){
  const a = AFFINE_TRANSFORM(611, trans, move);
  const b = AFFINE_TRANSFORM(649, trans, move);
  const c = AFFINE_TRANSFORM(612, trans, move);
  const d = AFFINE_TRANSFORM(685, trans, move);
  const e = AFFINE_TRANSFORM(647, trans, move);
  const bd = this.board

  if (!action) {
    return !this.play_attack_defend_n(color, 1, 3, [a, b, c, a]);
  }
  return bd.countlib(d)>2 && bd.countlib(e)>2 && 
  !this.play_attack_defend_n(bd.OTHER_COLOR(color), 1, 1, [a, e])
...
const autohelperbarrierspat102 = function (trans, move, color, action){
  ...
  return !this.play_attack_defend_n(this.board.OTHER_COLOR(color), 1, 1, [a, b])
...
const autohelperbarrierspat103 = function (trans, move, color, action){
  ...
  const c = AFFINE_TRANSFORM(684, trans, move);
  const d = AFFINE_TRANSFORM(647, trans, move);
  const e = AFFINE_TRANSFORM(610, trans, move);
  const f = AFFINE_TRANSFORM(611, trans, move);
  const A = AFFINE_TRANSFORM(648, trans, move);
  const bd = this.board

  if (!action) {
    return bd.countlib(A)===2 && !this.play_attack_defend_n(color, 1, 1, [b, b]);
  }
  return !this.play_attack_defend_n(bd.OTHER_COLOR(color), 1, 1, [c, d]) 
  && this.play_attack_defend2_n(bd.OTHER_COLOR(color), 0, 1, [e, d, f])
...
const autohelperbarrierspat107 = function (trans, move, color, action){
  ...
  if (!action)
    return this.play_attack_defend2_n(color, 1, 4, [a, b, c, d, b, d]);
  return !this.play_attack_defend_n(this.board.OTHER_COLOR(color), 1, 1, [b, e])

}
const autohelperbarrierspat108 = function (trans, move, color, action){

  const a = AFFINE_TRANSFORM(719, trans, move);
  const b = AFFINE_TRANSFORM(682, trans, move);
...
const autohelperbarrierspat112 = function (trans, move, color, action){
  const a = AFFINE_TRANSFORM(611, trans, move);
  const b = AFFINE_TRANSFORM(612, trans, move);
  const c = AFFINE_TRANSFORM(575, trans, move);
  const d = AFFINE_TRANSFORM(574, trans, move);
...
const autohelperbarrierspat114 = function (trans, move, color, action){
  ...
  const a = AFFINE_TRANSFORM(647, trans, move);
  const b = AFFINE_TRANSFORM(646, trans, move);
  const c = AFFINE_TRANSFORM(683, trans, move);
  const d = AFFINE_TRANSFORM(609, trans, move);
  const e = AFFINE_TRANSFORM(684, trans, move);
  const f = AFFINE_TRANSFORM(682, trans, move);

  return this.play_attack_defend_n(color, 1, 6, [a, b, c, d, e, f, f]);
}
const autohelperbarrierspat115 = function (trans, move, color, action){
  const a = AFFINE_TRANSFORM(647, trans, move);
  const b = AFFINE_TRANSFORM(646, trans, move);
  const c = AFFINE_TRANSFORM(645, trans, move);

  if (!action) {
    return this.play_connect_n(color, 1, 2, a, b, a, c);
  }
  return (!this.play_attack_defend_n(this.board.OTHER_COLOR(color), 1, 1, [b, c]));
...
const autohelperbarrierspat120 = function (trans, move, color, action){
  const a = AFFINE_TRANSFORM(535, trans, move);
  const b = AFFINE_TRANSFORM(498, trans, move);
  const c = AFFINE_TRANSFORM(573, trans, move);
  const d = AFFINE_TRANSFORM(574, trans, move);
  const e = AFFINE_TRANSFORM(537, trans, move);
  const f = AFFINE_TRANSFORM(499, trans, move);

  return this.play_attack_defend_n(color, 1, 6, [a, b, c, d, e, f, d]);
...
const autohelperbarrierspat127 = function (trans, move, color, action){
  ...
  const e = AFFINE_TRANSFORM(608, trans, move);
  const D = AFFINE_TRANSFORM(610, trans, move);

  return (this.somewhere(color, 0, 1, [e]) || !this.safe_move(e, this.board.OTHER_COLOR(color)))
   && !this.play_attack_defend_n(color, 0, 3, [a, b, c, D]);

}
const autohelperbarrierspat128 = function (trans, move, color, action){
  const b = AFFINE_TRANSFORM(536, trans, move);
  const c = AFFINE_TRANSFORM(498, trans, move);
...
const autohelperbarrierspat129 = function (trans, move, color, action){
  ...
  const a = AFFINE_TRANSFORM(574, trans, move);
  const b = AFFINE_TRANSFORM(537, trans, move);
  const c = AFFINE_TRANSFORM(536, trans, move);
  const e = AFFINE_TRANSFORM(611, trans, move);
  const f = AFFINE_TRANSFORM(610, trans, move);
  const D = AFFINE_TRANSFORM(573, trans, move);

  if (!action) {
    return this.safe_move(a, color) 
    && (this.somewhere(color, 0, 1, [e]) || this.play_attack_defend_n(color, 1, 2, [a, e, e]))
    && !this.play_attack_defend2_n(color, 0, 3, [a, b, c, b, D]);
  }
  return !this.play_attack_defend_n(this.board.OTHER_COLOR(color), 1, 1, [a, f]) && (this.somewhere(color, 0, 1, [e])
   || (!this.play_attack_defend_n(this.board.OTHER_COLOR(color), 1, 1, [e, f])));
...
const autohelperbarrierspat130 = function (trans, move, color, action){
  ...
  const c = AFFINE_TRANSFORM(536, trans, move);
  const d = AFFINE_TRANSFORM(571, trans, move);
  const e = AFFINE_TRANSFORM(535, trans, move);
  const h = AFFINE_TRANSFORM(609, trans, move);
  const F = AFFINE_TRANSFORM(572, trans, move);
  const G = AFFINE_TRANSFORM(608, trans, move);

  if (!action) {
    return this.safe_move(a, color) 
    && (this.somewhere(color, 0, 1, [b]) || this.play_attack_defend_n(color, 1, 2, [a, b, b]))
    && !this.play_attack_defend2_n(color, 0, 4, [a, c, d, e, F, G]);
  }
  return !this.play_attack_defend_n(this.board.OTHER_COLOR(color), 1, 1, [a, h])
...
const autohelperbarrierspat131 = function (trans, move, color, action){
  ...
  return this.safe_move(a, color) && this.play_attack_defend_n(color, 1, 2, [a, b, C]);
...
const autohelperbarrierspat132 = function (trans, move, color, action){
  ...
  const a = AFFINE_TRANSFORM(648, trans, move);
  const b = AFFINE_TRANSFORM(647, trans, move);
  const c = AFFINE_TRANSFORM(574, trans, move);
  const d = AFFINE_TRANSFORM(610, trans, move);
...
const autohelperbarrierspat136 = function (trans, move, color, action){
  ...
  const a = AFFINE_TRANSFORM(757, trans, move);
  const b = AFFINE_TRANSFORM(721, trans, move);
  const c = AFFINE_TRANSFORM(719, trans, move);
  const d = AFFINE_TRANSFORM(683, trans, move);

  return !this.play_attack_defend2_n(color, 1, 3, [a, b, c, c, d]);
}
const autohelperbarrierspat137 = function (trans, move, color, action){
  ...
  if (!action) {
    return this.play_break_through_n(color, 2, [a, b, C, b, D]);
  }
  return !this.play_attack_defend_n(this.board.OTHER_COLOR(color), 1, 1, [a, e])
...
const autohelperbarrierspat138 = function (trans, move, color, action){
  ...
  return  (this.play_break_through_n(color, 0, [a, b, c])=== codes.WIN 
   && (!this.board.is_ko_point(a) || this.play_attack_defend2_n(color, 1, 1, [d, b, c]))  
   && (!this.board.is_ko_point(c) || this.play_attack_defend2_n(color, 1, 1, [e, b, a])));
...
const autohelperbarrierspat140 = function (trans, move, color, action){
  ...
  const a = AFFINE_TRANSFORM(719, trans, move);
  const B = AFFINE_TRANSFORM(720, trans, move);

  return !this.play_attack_defend_n(color, 0, 1, [a, B]);
}
const autohelperbarrierspat141 = function (trans, move, color, action){
  ...
  const c = AFFINE_TRANSFORM(647, trans, move);
  const d = AFFINE_TRANSFORM(573, trans, move);
  const e = AFFINE_TRANSFORM(571, trans, move);
  const f = AFFINE_TRANSFORM(535, trans, move);
  const G = AFFINE_TRANSFORM(608, trans, move);

  return (this.somewhere(color, 0, 1, [a]) 
  || this.somewhere(color, 0, 1, [b]) 
  || this.somewhere(color, 0, 1, [c]))
  && (this.somewhere(color, 0, 1, [a]) 
  || this.play_attack_defend_n(color, 1, 2, [d, a, a])) 
  && this.play_attack_defend_n(color, 1, 2, [e, f, G]);

}
const autohelperbarrierspat142 = function (trans, move, color, action){
  const a = AFFINE_TRANSFORM(496, trans, move);
  const b = AFFINE_TRANSFORM(457, trans, move);
  const c = AFFINE_TRANSFORM(494, trans, move);
  const d = AFFINE_TRANSFORM(531, trans, move);
  const e = AFFINE_TRANSFORM(456, trans, move);
  const f = AFFINE_TRANSFORM(493, trans, move);
  const g = AFFINE_TRANSFORM(530, trans, move);

  return this.somewhere(this.board.OTHER_COLOR(color), 0, 6,[ b, c, d, e, f, g]) && this.safe_move(a, color);

}
const autohelperbarrierspat143 = function (trans, move, color, action){

  const a = AFFINE_TRANSFORM(458, trans, move);
  const b = AFFINE_TRANSFORM(570, trans, move);
  const c = AFFINE_TRANSFORM(457, trans, move);
  const d = AFFINE_TRANSFORM(494, trans, move);
  const e = AFFINE_TRANSFORM(531, trans, move);
  const f = AFFINE_TRANSFORM(456, trans, move);
  const g = AFFINE_TRANSFORM(493, trans, move);
  const h = AFFINE_TRANSFORM(530, trans, move);

  return this.somewhere(this.board.OTHER_COLOR(color), 0, 6, [c, d, e, f, g, h]) 
  && !this.play_connect_n(color, 0, 1, [a, a, b]);
...
const autohelperbarrierspat145 = function (trans, move, color, action){
  ...
  const e = AFFINE_TRANSFORM(648, trans, move);
  const f = AFFINE_TRANSFORM(609, trans, move);
  const g = AFFINE_TRANSFORM(571, trans, move);

  return !this.play_connect_n(color, 0, 0, [f, g]) && !this.play_connect_n(color, 0, 5, [a, b, c, d, e, c, f]);
...
const autohelperbarrierspat148 = function (trans, move, color, action){
  const a = AFFINE_TRANSFORM(643, trans, move);
  const b = AFFINE_TRANSFORM(607, trans, move);
  const c = AFFINE_TRANSFORM(681, trans, move);
  const D = AFFINE_TRANSFORM(682, trans, move);
  const E = AFFINE_TRANSFORM(644, trans, move);

  return !this.play_connect_n(color, 1, 3, [a, b, c, D, E]);
}
const autohelperbarrierspat149 = function (trans, move, color, action){
  const a = AFFINE_TRANSFORM(683, trans, move);
  const b = AFFINE_TRANSFORM(609, trans, move);
  const c = AFFINE_TRANSFORM(610, trans, move);
  const D = AFFINE_TRANSFORM(647, trans, move);

  if (!action) {
    return this.play_attack_defend_n(color, 1, 2, [c, b, D]);
  }
  return !this.safe_move(a, this.board.OTHER_COLOR(color)) 
  && !this.play_attack_defend2_n(color, 0, 3, [c, b, a, b, D]);
...
const autohelperbarrierspat150 = function (trans, move, color, action){
  ...
  const a = AFFINE_TRANSFORM(609, trans, move);
  const b = AFFINE_TRANSFORM(683, trans, move);
  const c = AFFINE_TRANSFORM(718, trans, move);
  const D = AFFINE_TRANSFORM(755, trans, move);

  return this.board.accuratelib(a, color, this.board.MAX_LIBERTIES, null)>1 
  && !this.play_connect_n(color, 1, 3, [a, b, c, b, D]);
...
const autohelperbarrierspat151 = function (trans, move, color, action){
  ...
  if (!this.false_eye_territory[a]) {
    this.influence_mark_non_territory(a, color);
  }
  if (!this.false_eye_territory[b]) {
...
const autohelperbarrierspat152 = function (trans, move, color, action){
  ...
  if ((this.is_halfeye(this.half_eye,a) || this.is_false_eye(this.half_eye, a)) 
  && this.safe_move(b, color) && !this.false_eye_territory[a]) {
     this.influence_mark_non_territory(a, this.board.OTHER_COLOR(color))
   }
...
const autohelperbarrierspat153 = function (trans, move, color, action){
  ...
  if (this.is_false_eye(this.half_eye, a) && !this.false_eye_territory[a]) {
    this.influence_mark_non_territory(a, color);
  }
  return 0;
...
const autohelperbarrierspat156 = function (trans, move, color, action){
  ...
  if (!this.false_eye_territory[a]) this.influence_mark_non_territory(a, color);
  if (!this.false_eye_territory[b]) this.influence_mark_non_territory(b, this.board.OTHER_COLOR(color));;
...
const autohelperbarrierspat160 = function (trans, move, color, action){
  ...
  if (!action){
    ...
    return this.safe_move(a, color) && this.play_attack_defend_n(color, 1, 3, [a, b, c, a]) 
    && this.connect_and_cut_helper2(a, b, c, color);
  }
  this.influence_mark_non_territory(c, this.board.OTHER_COLOR(color));;

  return 0;
}
const autohelperbarrierspat161 = function (trans, move, color, action){
  const a = AFFINE_TRANSFORM(611, trans, move);
  const b = AFFINE_TRANSFORM(574, trans, move);
  const c = AFFINE_TRANSFORM(573, trans, move);
  const e = AFFINE_TRANSFORM(537, trans, move);
  const D = AFFINE_TRANSFORM(610, trans, move);

  if (!action) {
    return !this.play_attack_defend2_n(color, 0, 3, [a, b, c, b, D]);
  }
  this.influence_mark_non_territory(b, this.board.OTHER_COLOR(color));
  this.influence_mark_non_territory(c, this.board.OTHER_COLOR(color));
  this.influence_mark_non_territory(e, this.board.OTHER_COLOR(color));
...
const autohelperbarrierspat163 = function (trans, move, color, action){
  ...
  if (!action) {
    return this.safe_move(a, color) && !this.play_attack_defend2_n(color, 0, 5, [a, b, c, NO_MOVE, d, b, E]);
  }
  this.influence_mark_non_territory(d, this.board.OTHER_COLOR(color));

  return 0;
}
const autohelperbarrierspat164 = function (trans, move, color, action){
  const a = AFFINE_TRANSFORM(537, trans, move);
  const b = AFFINE_TRANSFORM(536, trans, move);
  const c = AFFINE_TRANSFORM(499, trans, move);
...
const autohelperbarrierspat165 = function (trans, move, color, action){
  const a = AFFINE_TRANSFORM(718, trans, move);
  const b = AFFINE_TRANSFORM(755, trans, move);
  const c = AFFINE_TRANSFORM(681, trans, move);
  const d = AFFINE_TRANSFORM(717, trans, move);
  const e = AFFINE_TRANSFORM(680, trans, move);
...
const autohelperbarrierspat166 = function (trans, move, color, action){
  const a = AFFINE_TRANSFORM(612, trans, move);
  const c = AFFINE_TRANSFORM(685, trans, move);
  const B = AFFINE_TRANSFORM(648, trans, move);

  if (!action) {
    return this.safe_move(a, color) && this.play_attack_defend_n(color, 1, 1, [a, B]);
  }
  this.influence_mark_non_territory(c, this.board.OTHER_COLOR(color));
...
const autohelperbarrierspat169 = function (trans, move, color, action){
  const a = AFFINE_TRANSFORM(681, trans, move);
  const b = AFFINE_TRANSFORM(718, trans, move);
  const c = AFFINE_TRANSFORM(680, trans, move);
...
const autohelperbarrierspat170 = function (trans, move, color, action){
  const a = AFFINE_TRANSFORM(680, trans, move);
  const b = AFFINE_TRANSFORM(717, trans, move);
  const c = AFFINE_TRANSFORM(679, trans, move);
  const d = AFFINE_TRANSFORM(716, trans, move);
  const e = AFFINE_TRANSFORM(678, trans, move);
  const f = AFFINE_TRANSFORM(715, trans, move);
  ...
  this.influence_mark_non_territory(d, this.board.OTHER_COLOR(color))
  this.influence_mark_non_territory(e, this.board.OTHER_COLOR(color))
  this.influence_mark_non_territory(f, this.board.OTHER_COLOR(color));
...
const autohelperbarrierspat171 = function (trans, move, color, action){
  ...
  const d = AFFINE_TRANSFORM(646, trans, move);
  const e = AFFINE_TRANSFORM(608, trans, move);
...
const autohelperbarrierspat172 = function (trans, move, color, action){
  ...
  if (!action){
    return !this.play_attack_defend2_n(color, 0, 4, [a, b, NO_MOVE, c, a, d]);
  }
  this.influence_mark_non_territory(a, color);
  this.influence_mark_non_territory(c, color);
...
const autohelperbarrierspat173 = function (trans, move, color, action){
  ...
  if (!action) {
    return !this.play_attack_defend2_n(this.board.OTHER_COLOR(color), 0, 1, [a, b, c]);
  }
  this.influence_mark_non_territory(a, color);;
...
const autohelperbarrierspat174 = function (trans, move, color, action){
  ...
  if (!action) {
    return !this.play_attack_defend2_n(color, 0, 5, [a, b, c, NO_MOVE, d, b, E]);
  }
  this.influence_mark_non_territory(a, this.board.OTHER_COLOR(color))
  this.influence_mark_non_territory(b, this.board.OTHER_COLOR(color))
  this.influence_mark_non_territory(d, this.board.OTHER_COLOR(color));
...
const autohelperbarrierspat175 = function (trans, move, color, action){
  ...
  const b = AFFINE_TRANSFORM(573, trans, move);
  const c = AFFINE_TRANSFORM(574, trans, move);
  const d = AFFINE_TRANSFORM(537, trans, move);
  const e = AFFINE_TRANSFORM(648, trans, move);
  const f = AFFINE_TRANSFORM(536, trans, move);

  if (!action) {
    return !this.play_attack_defend2_n(color, 0, 7, [a, b, c, d, e, NO_MOVE, f, d, b]);
  }
  this.influence_mark_non_territory(a, this.board.OTHER_COLOR(color))
  this.influence_mark_non_territory(b, this.board.OTHER_COLOR(color))
  this.influence_mark_non_territory(c, this.board.OTHER_COLOR(color))
...
const autohelperbarrierspat178 = function (trans, move, color, action){
  const a = AFFINE_TRANSFORM(609, trans, move);
  const b = AFFINE_TRANSFORM(645, trans, move);
  const c = AFFINE_TRANSFORM(608, trans, move);

  if (!action) {
    return !this.play_attack_defend_n(color, 1, 2, [a, b, b]) && !this.play_attack_defend_n(color, 1, 2, [b, a, a]);
  }
  this.influence_mark_non_territory(a, color)
  this.influence_mark_non_territory(b, color)
  this.influence_mark_non_territory(c, color);
...
const autohelperbarrierspat179 = function (trans, move, color, action){
  ...
  if (!action) {
    return this.safe_move(move, color);
  }
  this.influence_mark_non_territory(move, this.board.OTHER_COLOR(color))
  this.influence_mark_non_territory(a, this.board.OTHER_COLOR(color));
...
const autohelperbarrierspat182 = function (trans, move, color, action){
  ...
  if (!action) {
    return this.board.countlib(A)===2 && this.connect_and_cut_helper(A, b, c);
  }
  this.influence_mark_non_territory(b, color);
  this.influence_mark_non_territory(c, color);;
...
const autohelperbarrierspat186 = function (trans, move, color, action){
  ...
  if (!action) {
    return !this.safe_move(a, color) && this.play_attack_defend_n(color, 1, 2, [b, a, b]);
  }
  this.influence_mark_non_territory(b, color);
  this.influence_mark_non_territory(c, color);;
...
const autohelperbarrierspat187 = function (trans, move, color, action){
  ...
  if (!action) {
    return this.play_attack_defend_n(color, 1, 2, [a, b, b]) 
    && !this.play_attack_defend_n(color, 1, 3, [a, c, b, b]) 
    && this.play_attack_defend_n(color, 1, 3, [a, c, b, E]);
  }
  this.influence_mark_non_territory(c, this.board.OTHER_COLOR(color))
  this.influence_mark_non_territory(d, this.board.OTHER_COLOR(color));
...
const autohelperbarrierspat188 = function (trans, move, color, action){
  ...
  if (!action) {
    return this.play_attack_defend_n(color, 1, 2, [a, b, b]) 
    && this.play_attack_defend_n(color, 1, 3, [a, c, b, c]);
  }
  this.influence_mark_non_territory(c, this.board.OTHER_COLOR(color))
  this.influence_mark_non_territory(d, this.board.OTHER_COLOR(color));
...
const autohelperbarrierspat189 = function (trans, move, color, action){
  const a = AFFINE_TRANSFORM(574, trans, move);
  const b = AFFINE_TRANSFORM(575, trans, move);
  const c = AFFINE_TRANSFORM(612, trans, move);
  const d = AFFINE_TRANSFORM(537, trans, move);
  const e = AFFINE_TRANSFORM(536, trans, move);

  if (!action) {
    return !this.play_attack_defend_n(color, 1, 5, [a, b, c, d, e, d]);
  }
  this.influence_mark_non_territory(a, color)
  this.influence_mark_non_territory(c, color)
  this.influence_mark_non_territory(e, color);
...
const autohelperbarrierspat190 = function (trans, move, color, action){
  ...
  const c = AFFINE_TRANSFORM(685, trans, move);
  const d = AFFINE_TRANSFORM(686, trans, move);

  if (!action) {
    return !this.play_attack_defend_n(color, 1, 3, [a, b, c, a]) 
    && !this.play_attack_defend_n(color, 1, 3, [a, c, b, a]);
  }
  this.influence_mark_non_territory(b, this.board.OTHER_COLOR(color))
  this.influence_mark_non_territory(c, this.board.OTHER_COLOR(color))
  this.influence_mark_non_territory(d, this.board.OTHER_COLOR(color));
...
const autohelperbarrierspat191 = function (trans, move, color, action){
  ...
  const a = AFFINE_TRANSFORM(573, trans, move);
  const b = AFFINE_TRANSFORM(575, trans, move);
  const c = AFFINE_TRANSFORM(537, trans, move);

  if (!action) {
    return this.safe_move(a, color)&& 
    ((this.somewhere(this.board.OTHER_COLOR(color), 0, 1, [b]) && this.play_attack_defend_n(color, 1, 1, [a, b]))    
    || (!this.somewhere(this.board.OTHER_COLOR(color), 0, 1, [b]) && this.play_attack_defend_n(color, 1, 2, [a, b, b])));
  }
  this.influence_mark_non_territory(c, this.board.OTHER_COLOR(color));;
...
const autohelperbarrierspat194 = function (trans, move, color, action){
  ...
  if (!action) {
    return this.board.countlib(B)===3 && this.safe_move(a, color) && this.play_attack_defend_n(color, 1, 1, [a, B]);
  }
  this.influence_mark_non_territory(c, this.board.OTHER_COLOR(color));
...
const autohelperbarrierspat195 = function (trans, move, color, action){
  ...
  const a = AFFINE_TRANSFORM(723, trans, move);
  const b = AFFINE_TRANSFORM(760, trans, move);
  const c = AFFINE_TRANSFORM(722, trans, move);
...
const autohelperbarrierspat196 = function (trans, move, color, action){
  const a = AFFINE_TRANSFORM(721, trans, move);
  const b = AFFINE_TRANSFORM(723, trans, move);
  const C = AFFINE_TRANSFORM(760, trans, move);
  const D = AFFINE_TRANSFORM(722, trans, move);

  if (!action) {
    return !this.play_attack_defend2_n(color, 0, 3, [a, NO_MOVE, b, C, D]);
  }
  this.influence_mark_non_territory(b, this.board.OTHER_COLOR(color));
...
const autohelperbarrierspat197 = function (trans, move, color, action){
  ...
  const c = AFFINE_TRANSFORM(685, trans, move);
  const d = AFFINE_TRANSFORM(612, trans, move);
  const e = AFFINE_TRANSFORM(650, trans, move);

  if (!action) {
    return !this.play_attack_defend_n(color, 0, 4, [a, b, c, d, a]);
  }
  this.influence_mark_non_territory(d, color)
  this.influence_mark_non_territory(e, color);
...
const autohelperbarrierspat199 = function (trans, move, color, action){
  ...
  if (!action) {
    return !this.play_attack_defend2_n(this.board.OTHER_COLOR(color), 0, 1, [a, b, c]) 
    && !this.adjacent_to_defendable_stone_in_atari(b)
    && !this.adjacent_to_defendable_stone_in_atari(c);
  }
  this.influence_mark_non_territory(a, color);
...
const autohelperbarrierspat200 = function (trans, move, color, action){
  ...
  if (!action) {
    return !this.play_attack_defend_n(color, 1, 1, [b, D]) && !this.play_attack_defend_n(color, 1, 2, [b, c, c]);
  }
  this.influence_mark_non_territory(a, color);;
...
const autohelperbarrierspat201 = function (trans, move, color, action){
  ...
  const a = AFFINE_TRANSFORM(760, trans, move);
  const b = AFFINE_TRANSFORM(797, trans, move);
  const c = AFFINE_TRANSFORM(722, trans, move);
  const d = AFFINE_TRANSFORM(834, trans, move);
  const e = AFFINE_TRANSFORM(685, trans, move);

  if (!action) {
    return this.play_attack_defend_n(color, 1, 2, [a, b, c]) && !this.play_attack_defend_n(color, 1, 2, [b, d, d]);
  }
  this.influence_mark_non_territory(e, color);;
...
const autohelperbarrierspat202 = function (trans, move, color, action){
  ...
  if (!action)
    return this.board.countlib(C)===2 && this.safe_move(a, color) 
    && this.play_attack_defend_n(color, 1, 1, [a, C]) 
...
const autohelperbarrierspat203 = function (trans, move, color, action){
  ...
  const b = AFFINE_TRANSFORM(611, trans, move);
  const c = AFFINE_TRANSFORM(575, trans, move);
  const d = AFFINE_TRANSFORM(576, trans, move);
  const e = AFFINE_TRANSFORM(612, trans, move);
  const f = AFFINE_TRANSFORM(649, trans, move);

  if (!action) {
    return this.play_attack_defend_n(color, 0, 6, [a, b, c, d, e, f, a]);
  }
  this.influence_mark_non_territory(b, this.board.OTHER_COLOR(color))
  this.influence_mark_non_territory(c, this.board.OTHER_COLOR(color))
  this.influence_mark_non_territory(d, this.board.OTHER_COLOR(color))
...
const autohelperbarrierspat204 = function (trans, move, color, action){
  const a = AFFINE_TRANSFORM(720, trans, move);
  const b = AFFINE_TRANSFORM(794, trans, move);
  const e = AFFINE_TRANSFORM(757, trans, move);
  const C = AFFINE_TRANSFORM(683, trans, move);
  const D = AFFINE_TRANSFORM(831, trans, move);

  if (!action) {
    return !this.play_attack_defend_n(color, 1, 1, [a, C]) && !this.play_attack_defend_n(color, 1, 1, [b, D]);
  }
  this.influence_mark_non_territory(e, color);
...
const autohelperbarrierspat205 = function (trans, move, color, action){
  const a = AFFINE_TRANSFORM(720, trans, move);
  const b = AFFINE_TRANSFORM(757, trans, move);
  const c = AFFINE_TRANSFORM(758, trans, move);
  const d = AFFINE_TRANSFORM(719, trans, move);

  if (!action) {
    return !this.play_attack_defend2_n(color, 0, 2, [a, b, a, c]);
  }
  this.influence_mark_non_territory(b, color);
  this.influence_mark_non_territory(d, color);;
...
const autohelperbarrierspat206 = function (trans, move, color, action){
  const a = AFFINE_TRANSFORM(648, trans, move);
  const b = AFFINE_TRANSFORM(611, trans, move);
  const c = AFFINE_TRANSFORM(649, trans, move);
  const d = AFFINE_TRANSFORM(612, trans, move);
...
const autohelperbarrierspat207 = function (trans, move, color, action){
  ...
  const b = AFFINE_TRANSFORM(574, trans, move);
  const c = AFFINE_TRANSFORM(612, trans, move);
  const d = AFFINE_TRANSFORM(575, trans, move);
...
const autohelperbarrierspat208 = function (trans, move, color, action){
  ...
  const b = AFFINE_TRANSFORM(611, trans, move);
  const c = AFFINE_TRANSFORM(612, trans, move);
  const d = AFFINE_TRANSFORM(649, trans, move);

  if (!action) {
    return !this.safe_move(a, color) && 
    !this.play_attack_defend2_n(color, 0, 4, [b, a, NO_MOVE, c, b, d]);
  }
  this.influence_mark_non_territory(c, color);
...
const autohelperbarrierspat209 = function (trans, move, color, action){
  ...
  if (!action){
    return this.board.countlib(C)===2 && !this.adjacent_to_stone_in_atari(C) && !this.play_attack_defend2_n(color, 1, 1, [a, a, b]);
  }
  this.influence_mark_non_territory(d, this.board.OTHER_COLOR(color));
...
const autohelperbarrierspat210 = function (trans, move, color, action){
  ...
  if (!action){
    return this.play_attack_defend_n(color, 1, 2, [a, b, b]) 
    && !this.play_attack_defend2_n(color, 1, 1, [a, a, c]);
  }
  this.influence_mark_non_territory(d, this.board.OTHER_COLOR(color));;
...
const autohelperbarrierspat211 = function (trans, move, color, action){
  ...
  if (!action) {
    return this.play_attack_defend2_n(color, 0, 3, [a, b, c, D, b]) 
    && this.play_attack_defend_n(color, 1, 2, [a, b, a]);
  }
  this.influence_mark_non_territory(e, color);;
...
const autohelperbarrierspat212 = function (trans, move, color, action){
  ...
  if (!action){
    return !this.play_attack_defend_n(color, 1, 3, [a, b, c, a])
     && !this.play_attack_defend_n(color, 1, 3,[ a, d, c, a]);
  }
  this.influence_mark_non_territory(b, this.board.OTHER_COLOR(color));;
...
const autohelperbarrierspat213 = function (trans, move, color, action){
  const a = AFFINE_TRANSFORM(719, trans, move);
  const b = AFFINE_TRANSFORM(720, trans, move);
  const c = AFFINE_TRANSFORM(756, trans, move);
  const d = AFFINE_TRANSFORM(758, trans, move);
  const e = AFFINE_TRANSFORM(682, trans, move);

  if (!action){
    return this.play_attack_defend_n(color, 1, 4, [a, b, c, d, d]);
  }
  this.influence_mark_non_territory(e, this.board.OTHER_COLOR(color));;
...
const autohelperbarrierspat214 = function (trans, move, color, action){
  const a = AFFINE_TRANSFORM(575, trans, move);
  const b = AFFINE_TRANSFORM(537, trans, move);
  const c = AFFINE_TRANSFORM(612, trans, move);
  const d = AFFINE_TRANSFORM(538, trans, move);
  const e = AFFINE_TRANSFORM(573, trans, move);

  if (!action){
    return this.safe_move(a, color) && this.play_attack_defend_n(color, 1, 4, [a, b, c, d, b]);
  }
  this.influence_mark_non_territory(e, this.board.OTHER_COLOR(color));
...
const autohelperbarrierspat215 = function (trans, move, color, action){
  const a = AFFINE_TRANSFORM(722, trans, move);
  const b = AFFINE_TRANSFORM(759, trans, move);
  const c = AFFINE_TRANSFORM(796, trans, move);
  const D = AFFINE_TRANSFORM(684, trans, move);
  const E = AFFINE_TRANSFORM(832, trans, move);

  if (!action) {
    return !this.play_attack_defend2_n(color, 1, 2, [a, c, D, c]) 
    && !this.play_attack_defend2_n(color, 1, 2, [c, a, E, a]);
  }
  this.influence_mark_non_territory(b, color);
...
const autohelperbarrierspat216 = function (trans, move, color, action){
  ...
  const c = AFFINE_TRANSFORM(722, trans, move);
  const D = AFFINE_TRANSFORM(611, trans, move);
  const E = AFFINE_TRANSFORM(721, trans, move);
